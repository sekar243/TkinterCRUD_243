...
# Menambahkan kondisi nilai yang berbeda untuk setiap pilihan prodi
...
class AppNilai(tk.Tk):
    ...
    def __init__(self):
        ...
        #input nilai Biologi, Fisika, Inggris
        ...
        # Tombol-tombol Aksi (Submit dan Clear)
    ...
    def delete_data(self):
        ...
        if msg.askyesno("Konfirmasi", "Apakah Anda yakin ingin menghapus data ini?"):
            ...
            self.load_data()  # Muat ulang tabel
            self.clear_inputs()  # Bersihkan form
    ...
    def clear_inputs(self):
        ...
        self.ent_fis.delete(0, tk.END)
        self.ent_ing.delete(0, tk.END)
        self.selected_id = None   # Reset ID yang dipilih
    ...
    def validate(self):
        try:
            ...
            # Cek apakah nama kosong atau nilai di luar batas 0-100
    ...
    def insert_data(self):
        # Fungsi yang dipanggil oleh tombol Submit (berfungsi untuk Insert dan Update)
        data = self.validate()
        if not data:
            return
